...
- **Stremio** — the media centre.
- **AIOStreams** — stream sources, filtering and sorting.
- **Tamtaro's SEL Filtering & Sorting** — powerful filtering and sorting templates.
...
The project is being built incrementally. The first goal is a polished, simple setup experience before adding integrations and advanced configuration.
...
- **Tamtaro** — SEL Filtering & Sorting and the associated configuration work.
- **Viren** — AIOStreams.
- **Cedya / Din** — AIOMetadata, as credited by Tamtaro.
- **Vidhin** — release regex work, as credited by Tamtaro.
- **Stremio** and its developers and community.

The project will keep its credits and acknowledgements visible as the implementation grows.

## Development

The project is intentionally being built in small, testable checkpoints.

More documentation will be added as the application takes shape.
